...
class image_converter:
    def __init__(self):    
        ...
        self.image_sub=rospy.Subscriber("/camera/image_raw", Image, self.callback)	#获取相机图像信息
        self.image_pub=rospy.Publisher("object_detect_image", Image, queue_size=5)	#图像识别结果的发布
        self.target_pub=rospy.Publisher("object_detect_pose", Pose, queue_size=5)	#发布目标结果在图像中的位置信息
